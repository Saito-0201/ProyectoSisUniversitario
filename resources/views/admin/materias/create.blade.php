                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: Matemáticas Discretas" required>
                                    </div>
                                    @error('nombre')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="codigo" value="{{ old('codigo') }}" placeholder="Ej: MAT-205" required>
                                    </div>
                                    @error('codigo')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
